...
1. **Client layer:** Decision Black Box (DBB) + Decision Surface (DS) + **Decision Intelligence (DI) Engine**
2. **Backend layer:** Knowledge Cache Graph (KCG) + DoD + Peaq + Arweave + Gateway consensus

The client captures decision truth and optimizes choices locally; the backend handles knowledge escalations and immutable storage.
