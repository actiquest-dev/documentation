...
This document provides a production-grade description of the Smart Persistence Layer (Reasoning Graph) in Membria: how GraphRAG, memory, DBB/DS, knowledge cache, and the LoRA lifecycle work together.

---

## 1. What is Reasoning Graph in Membria

**Reasoning Graph (Smart Persistence Layer)** is the layer between the user (or team) and any AI models that makes intelligence **cumulative** rather than disposable.
