...
## Workspace-level Smart Persistence Layer (SPL)

Membria for SMBs extends SPL from an individual to a **shared workspace**. All connected sources contribute to a shared reasoning layer that captures:
- Team decisions
