...
- **Sub-lingual markers:** Team response latency, skepticism cues, and redundancy in reasoning (signals for **POMDP Hidden Divergence**).
...
- **DI Metadata:** Potential impact markers (stakes) for **VoI scoring** and coordination cues.
...
- **Hidden Divergence Alerts** (POMDP-detected consensus gaps)
