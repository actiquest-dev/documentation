---
title: "DBB (Decision Black Box) heuristics"
...
### 6. Coordination & Consistency Signals (DI)

These signals feed the **Decision Intelligence Engine** to detect hidden disagreement or coordination bottlenecks:
- **Response Latency Symmetry:** Large gaps between team members' responses or "too-fast" agreement after complex proposals.
- **Skepticism Cues:** Implicit markers of doubt (hedging language, red-teaming questions) that may contradict explicit "+1" agreements.
- **Reasoning Redundancy:** Multiple team members independently producing similar rationales, increasing confidence in "true" consensus.
